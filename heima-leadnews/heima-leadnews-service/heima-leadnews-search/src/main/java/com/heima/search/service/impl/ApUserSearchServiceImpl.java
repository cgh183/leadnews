...
public class ApUserSearchServiceImpl implements ApUserSearchService {
    ...
    public void insert(String keyword, Integer userId) {
        ...
        Query querynums = Query.query(Criteria.where("userId").is(userId));
        querynums.with(Sort.by(Sort.Direction.DESC,"createdTime"));
        List<ApUserSearch> apUserSearchList = mongoTemplate.find(querynums, ApUserSearch.class);
